/**
 * NEMT Platform - Publish Strategy Modal
 * Publish strategy to the market
 */
...
interface PublishStrategyModalProps {
  ...
  onClose: () => void;
  onPublish: (strategy: StrategyData, settings: PublishSettings) => void;
}
...
export function PublishStrategyModal({ 
  isOpen, 
  strategy, 
  onClose, 
  onPublish 
}: PublishStrategyModalProps) {
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-white">发布策略到市场</h2>
              <p className="text-xs" style={{ color: '#737373' }}>{strategy.name}</p>
            </div>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="介绍你的策略特点、适用场景、使用方法..."
              rows={3}
