"""POST /api/v1/phase — 相位检测端点."""
import time
from fastapi import APIRouter, Depends
from nemt_api.services.model_service import ModelService
from nemt_api.dependencies import get_model_service
from nemt_api.schemas.request import PhaseRequest

router = APIRouter()


@router.post("/phase")
async def detect_phase(request: PhaseRequest, service: ModelService = Depends(get_model_service)):
    t0 = time.time()
    ...
    result = service.detect_phase(klines_dicts)
